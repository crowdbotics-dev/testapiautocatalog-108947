...
## Project Structure
    ...
    ├── testapiautocatalog_108947  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_108947`
...
2. Clone this repo and `cd testapiautocatalog_108947`
